...
/**
 * Cross-app links use plain <a> (not next/link) — btn1To/btn2To point at routes still served by
 * the Vite app (e.g. /produse, /instalatori); next/link would try a same-app client navigation
 * and 404 since apps/site doesn't own those routes yet.
 */
