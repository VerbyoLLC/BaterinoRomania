...
function mergeCartLines(base: CartLine[], incoming: CartLine[]): CartLine[] {
  return incoming.reduce((acc, line) => mergeCartLineIntoList(acc, line), [...base])
}

export function CartProvider({ children }: { children: ReactNode }) {
  /** Starts empty on server and first client render to avoid hydration mismatch; real cart
   *  contents load from localStorage/API in the effect below. */
